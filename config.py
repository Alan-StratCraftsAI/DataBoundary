...
# Local models via ollama (OpenAI-compat endpoint, no real API key needed)
MODELS["gemma4_e4b"] = {
...
MODELS["qwen25_7b_64k_local"] = {
    "name": "Qwen 2.5 7B 64K (local)",
    "provider": "openai_compat",
...
RUN_PROFILES = {
    ...
    "gemma4_startup": {
        "description": "TICKET-001: Gemma 4 local model startup validation (4 cases)",
        "model_keys": ["gemma4_e4b"],
        "delimiter_lengths": [128],
        "delimiter_types": ["hex"],
        "templates": ["strict"],
        "payloads": ["direct_override", "delimiter_mimic"],
        "doc_lengths": ["medium"],
        "include_baseline": True,
        "per_tier_overrides": False,
    },
    "gemma4_coverage": {
        "description": "TICKET-001: Gemma 4 local model full coverage run",
        "model_keys": ["gemma4_e4b"],
        "delimiter_lengths": [128],
        "delimiter_types": ["hex"],
        "templates": ["strict", "contextual"],
    ...
    "gemma4_full_constraints": {
        "description": "TICKET-001: Gemma 4 local model full constraints matrix",
        "model_keys": ["gemma4_e4b"],
        "delimiter_lengths": DELIMITER_LENGTHS,
        "delimiter_types": list(DELIMITER_TYPES.keys()),
        "templates": DEFENSE_TEMPLATES,
    ...
    "qwen25_7b_startup": {
        "description": "Local Qwen 2.5 7B startup validation (4 cases)",
        "model_keys": ["qwen25_7b_local"],
        "delimiter_lengths": [128],
        "delimiter_types": ["hex"],
        "templates": ["strict"],
        "payloads": ["direct_override", "delimiter_mimic"],
    ...
    "qwen25_7b_coverage": {
        "description": "Local Qwen 2.5 7B coverage-200 run",
        "model_keys": ["qwen25_7b_local"],
        "delimiter_lengths": [128],
        "delimiter_types": ["hex"],
        "templates": ["strict", "contextual"],
    ...
    "llama31_8b_startup": {
        "description": "Local Llama 3.1 8B startup validation (4 cases)",
        "model_keys": ["llama31_8b_local"],
        "delimiter_lengths": [128],
        "delimiter_types": ["hex"],
        "templates": ["strict"],
        "payloads": ["direct_override", "delimiter_mimic"],
    ...
    "qwen35_9b_startup": {
        "description": "Local Qwen 3.5 9B startup validation (4 cases)",
    ...
    "glm4_9b_startup": {
        "description": "Local GLM-4 9B startup validation (4 cases)",
        "model_keys": ["glm4_9b_local"],
        "delimiter_lengths": [128],
        "delimiter_types": ["hex"],
        "templates": ["strict"],
        "payloads": ["direct_override", "delimiter_mimic"],
    ...
    "glm4_9b_coverage": {
        "description": "Local GLM-4 9B coverage-200 run",
        "model_keys": ["glm4_9b_local"],
        "delimiter_lengths": [128],
        "delimiter_types": ["hex"],
        "templates": ["strict", "contextual"],
    ...
    "llama31_8b_coverage": {
        "description": "Local Llama 3.1 8B coverage-200 run",
        "model_keys": ["llama31_8b_local"],
        "delimiter_lengths": [128],
        "delimiter_types": ["hex"],
        "templates": ["strict", "contextual"],
