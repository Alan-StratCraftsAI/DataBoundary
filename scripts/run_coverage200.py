...
PROFILE_NAME = "coverage200"
TICKET_ID = "TICKET-007"
TITLE = "Coverage200 Profile Progress"
PROGRESS_PATH = PROGRESS_DIR / "coverage200.md"


def main() -> int:
    parser = argparse.ArgumentParser(description="Run the coverage200 profile and update progress docs")
    ...
    commands: list[dict] = []
    notes = [
        "This script is the repo-standard entry point for the 200-case coverage profile.",
        "The progress tracker records unfinished work even when the full run is skipped.",
    ]
    ...
    if dry_run_result.returncode != 0:
        ...
        write_progress_doc(
            ...
            steps=steps,
            commands=commands,
            pending_items=["Fix the coverage200 profile before running the benchmark."],
    ...
    if args.dry_run:
        ...
        write_progress_doc(
            ...
            commands=commands,
            pending_items=[
                "Run the full coverage200 benchmark.",
    ...
    if run_result.returncode != 0:
        ...
        write_progress_doc(
            ...
            steps=steps,
            commands=commands,
            pending_items=["Investigate the benchmark failure and rerun the coverage200 profile."],
